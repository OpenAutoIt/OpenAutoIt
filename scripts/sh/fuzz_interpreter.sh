...
# Indefinite fuzz
$fuzzer corpus $samples_dir -use_value_profile=1 -close_fd_mask=1 -timeout=$timeout -jobs="$jobs" -workers="$jobs" -max_len=512 -rss_limit_mb=4096 $dictionaries -only_ascii=1
